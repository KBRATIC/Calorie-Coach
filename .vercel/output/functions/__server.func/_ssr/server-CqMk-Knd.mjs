...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-KLjfetDC.mjs");
...
var manifest = { "33d32b2a4cd3ca6a31ed7de074dfa3919e3b455ea165de04b22995ab2501c880": {
	functionName: "parseMeal_createServerFn_handler",
	importer: () => import("./ai.functions-CwbdR84w.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-kY2DGhYV.mjs").then((n) => n.t),
		import("./start-4yBS1NUW.mjs"),
...
//#endregion
export { getRequest as a, getServerFnById as i, createServerFn as n, TSS_SERVER_FUNCTION as r, server_exports as t };
